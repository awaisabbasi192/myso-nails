  ...
  return (
    <div style={{ maxWidth: 1240, margin: "0 auto", padding: "60px 24px 100px" }}>
      <div style={{ maxWidth: 560, marginBottom: 44 }}>
        <div style={{ fontSize: 11, letterSpacing: ".4em", textTransform: "uppercase", color: "rgba(168,121,104,.8)", marginBottom: 20 }}>Contact</div>
      ...
      <div data-r="split" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 22, alignItems: "start" }}>
        <div style={{ display: "grid", gap: 14 }}>
          <a href={waLink("Hi Myra!")} target="_blank" rel="noreferrer" className="btn-wa" style={{ background: "var(--panel)", padding: 30, display: "block" }}>
          ...
          <a href="https://instagram.com/pressonsby_myra" target="_blank" rel="noreferrer" className="card-soft" style={{ background: "var(--panel)", padding: 24, display: "block" }}>
            <div style={{ fontSize: 10.5, letterSpacing: ".24em", textTransform: "uppercase", color: "rgba(247,241,237,.45)" }}>Instagram</div>
            <div style={{ fontSize: 16, color: "var(--rose)", marginTop: 10 }}>@pressonsby_myra</div>
          </a>
          ...
          <div style={{ border: "1px solid rgba(168,121,104,.18)", background: "var(--panel)", padding: 28 }}>
            ...
            {FAQS.map((q) => (
              <div key={q.q} style={{ borderBottom: "1px solid rgba(168,121,104,.1)", padding: "14px 0" }}>
          ...
          <div style={{ border: "1px solid rgba(168,121,104,.18)", background: "var(--panel)", padding: 28 }}>
            ...
            <div className="contact-size-chart" style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 1, background: "rgba(168,121,104,.14)" }}>
              {SIZE_ROWS.map((r) => (
        ...
        <div style={{ border: "1px solid rgba(168,121,104,.18)", background: "var(--panel)", padding: 36 }}>
