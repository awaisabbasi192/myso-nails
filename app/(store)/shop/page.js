...
export const metadata = {
  title: "Shop all sets — Press-Ons by Myra",
  ...
  openGraph: { title: "Shop all sets — Press-Ons by Myra", description: "Hand-painted press-on nails sized to you. Free delivery over Rs 5,000." },
};
