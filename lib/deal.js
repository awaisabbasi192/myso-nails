...
export const DEAL_THEMES = {
  // "red" is the default slot — it follows whatever site palette the admin
  // picked, so the banner never clashes with the rest of the store.
  red:    { grad: "var(--grad)", text: "var(--btn-fg)", emoji: "⚡" },
...
const DEAL_SELECT = {
  ...
  dealMaxOrders: true, dealStartAt: true, dealTheme: true, dealMode: true,
};
